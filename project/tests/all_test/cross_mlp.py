...
ml_lib.addLayer(network, 8, cstring("sigmoid"))  # hidden layer 2
ml_lib.addLayer(network, 4, cstring("sigmoid"))  # hidden layer 3
ml_lib.addLayer(network, 2, cstring("sigmoid"))  # hidden layer 4
